      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col items-center mb-12 pb-8 border-b border-white/20">
          <div className="flex flex-wrap items-center justify-center gap-6 mb-6">
            <div className="bg-white p-4 rounded-lg flex items-center h-22">
              <Image 
                src="/logo-cdl.png" 
                alt="CDL Ipirá" 
                width={220}
          ...
          <div className="flex gap-4">
            <a suppressHydrationWarning href="#" className="bg-white text-[#003f7f] p-3 rounded-lg hover:bg-[#ffd000] hover:text-[#003f7f] transition-all transform hover:scale-110">
              <FaYoutube size={24} />
            </a>
            <a suppressHydrationWarning href="#" className="bg-white text-[#003f7f] p-3 rounded-lg hover:bg-[#ffd000] hover:text-[#003f7f] transition-all transform hover:scale-110">
              <FaFacebook size={24} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Institucional */}
          <div>
            <h3 suppressHydrationWarning className="text-lg font-bold mb-4 border-b-2 border-[#ffd000] pb-2">
              Institucional
            </h3>
        ...
        <div className="bg-white/5 rounded-xl p-8 backdrop-blur-sm">
          <h3 suppressHydrationWarning className="text-2xl font-bold mb-6 text-center text-[#ffd000]">Entre em Contato</h3>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition-all">
              <p suppressHydrationWarning className="font-bold mb-3 text-[#ffd000] text-sm uppercase">E-mail</p>
              <a suppressHydrationWarning href="mailto:cdlipira@ipiratech.com.br" className="hover:text-[#ffd000] transition-colors text-sm break-all">
                cdlipira@ipiratech.com.br
              </a>
            </div>
            
            <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition-all">
              <p suppressHydrationWarning className="font-bold mb-3 text-[#ffd000] text-sm uppercase">WhatsApp</p>
              <a suppressHydrationWarning href="https://wa.me/557532541599" target="_blank" rel="noopener noreferrer" className="hover:text-[#ffd000] flex items-center gap-2 transition-colors">
                <FaWhatsapp size={18} /> (75) 3254-1599
              </a>
            </div>
            
            <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition-all">
              <p suppressHydrationWarning className="font-bold mb-3 text-[#ffd000] text-sm uppercase">Telefone</p>
              <a suppressHydrationWarning href="tel:557599914-5061" className="hover:text-[#ffd000] flex items-center gap-2 transition-colors">
                <FaPhone size={16} /> (75) 99914-5061
              </a>
            </div>
            
            <div className="bg-white/10 rounded-lg p-4 hover:bg-white/15 transition-all">
              <p suppressHydrationWarning className="font-bold mb-3 text-[#ffd000] text-sm uppercase">Endereço</p>
              <p suppressHydrationWarning className="text-sm leading-relaxed">Avenida Cesár Cabral, Nº 164 - Passarela Center, L02<br />Centro, 44600-000<br />Ipirá-BA</p>
            </div>
          </div>
          
          <div className="text-center border-t border-white/20 pt-6">
            <p suppressHydrationWarning className="text-sm mb-1"><span className="font-bold text-[#ffd000]">CNPJ:</span> 63.110.076/0001-90</p>
            <p suppressHydrationWarning className="text-sm"><span className="font-bold text-[#ffd000]">Razão Social:</span> CDL - CÂMARA DE DIRIGENTES LOJISTAS DE IPIRÁ</p>
          </div>
        </div>
      </div>
