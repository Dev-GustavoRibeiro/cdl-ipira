...
// Keyframes injetados diretamente para escapar do CSS global, do
// pause-animations do widget de acessibilidade e do prefers-reduced-motion.
const KEYFRAMES = `
@keyframes ldExit {
...
@keyframes ldLogo {
  0%   { opacity:0; transform:scale(0.55) translateY(-24px); filter:blur(10px); }
...
const PARTICLES = [
  ...
  { left: '18%', delay: '0.4s',  dur: '3.2s' },
  { left: '30%', delay: '0.9s',  dur: '2.6s' },
  { left: '44%', delay: '0.2s',  dur: '3.5s' },
  { left: '57%', delay: '1.1s',  dur: '2.9s' },
  { left: '68%', delay: '0.6s',  dur: '3.1s' },
  { left: '79%', delay: '0.15s', dur: '2.7s' },
  { left: '90%', delay: '0.75s', dur: '3.3s' },
];
...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    const finish = () => {
      const remaining = Math.max(0, minDisplay - (Date.now() - start));
      setTimeout(() => {
        setPhase('fading');
        setTimeout(() => setPhase('gone'), 980);
      }, remaining);
    };
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          ...(exiting
            ? { animation: 'ldExit 0.9s cubic-bezier(0.4,0,0.6,1) forwards', pointerEvents: 'none' }
            : {}),
        }}
      >
        {/* Radial spotlight */}
        ...
        <div
          ...
          style={{ animation: 'ldLogo 0.75s cubic-bezier(0.34,1.5,0.64,1) both' }}
        >
          {/* Aura */}
          <div
            className="absolute"
        ...
        <div className="relative z-10 w-52 sm:w-72">
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  '0 0 8px rgba(255,208,0,0.7),0 0 18px rgba(0,102,204,0.5),0 0 32px rgba(0,102,204,0.2)',
                animation:
                  'ldBar 2.1s cubic-bezier(0.4,0,0.15,1) forwards, ldShimmer 1.4s linear 0.4s infinite',
              }}
            />
          </div>
          ...
          <div
            ...
            style={{
              ...
              filter: 'blur(6px)',
              animation: 'ldBar 2.1s cubic-bezier(0.4,0,0.15,1) forwards',
            }}
          />
        </div>
        ...
        <p
          ...
          style={{
            ...
            animation: 'ldTagline 0.7s ease-out 0.55s both',
          }}
        >
